...
I am a first-year PhD candidate at the [HKUST NLP Group](https://hkust-nlp.github.io/), advised by [Professor Junxian He](https://jxhe.github.io/). My research focuses on natural language processing and machine learning, with specific interests in LLM reasoning, reinforcement learning, hallucination in vision-language models, and LLM truthfulness and interpretability.

Prior to my PhD, I completed my B.Eng. at Shanghai Jiao Tong University, where I was also advised by Professor Junxian He. I have gained valuable research experience through internships at MINIMAX, Tencent WXG, and Shanghai AI Lab.
